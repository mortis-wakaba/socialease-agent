...
REQUIRED_THRESHOLDS = (
    ...
    EvalThreshold("memory_retrieval_recall_at_3", 1.0),
    EvalThreshold("memory_false_recall_avoidance", 1.0),
    EvalThreshold("memory_stale_recall_avoidance", 1.0),
    EvalThreshold("memory_conflict_resolution", 1.0),
    EvalThreshold("memory_cross_user_leakage_avoidance", 1.0),
    EvalThreshold("memory_no_memory_abstention", 1.0),
    EvalThreshold("memory_context_token_budget", 1.0),

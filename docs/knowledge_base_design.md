...
当前不保存合成的校园办公室、咨询中心、电话或预约渠道。未来只有在获得可验证的学校正式资料、明确 owner/reviewer 和更新机制后，才新增独立的 campus-specific 知识层。
...
5. 没有命中足够证据时，返回 unknown，不补全联系方式、机构名称或治疗效果承诺。
...
4. 学校专属资源保持未实现状态，直到有经过审核的真实导入来源与更新流程。
